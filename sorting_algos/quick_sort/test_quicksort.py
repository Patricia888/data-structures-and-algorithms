...
def test_radix_sort_reverse_sorted_list():
    ...
    assert quicksort(reverse_sorted_list) == [1, 3, 4, 5, 6, 19]
...
def test_selection_sort_all_negative_values():
    ...
    assert quicksort(negative_value_list) == [-70, -20, -5, -4, -1]
...
def test_radix_sort_repeat_numbers_in_list():
    ...
    assert quicksort(repeat_number_list) == [1, 2, 2, 4, 4, 4, 9, 9]
...
def test_radix_sort_list_with_big_numbers():
    ...
    assert quicksort(big_number_list) == [1, 2, 11, 203, 278, 3456, 87654]
